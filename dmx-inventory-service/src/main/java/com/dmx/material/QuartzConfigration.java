...
//
//        jobDetail.setName("produce-task");// 设置任务的名字
//        jobDetail.setGroup("produce");// 设置任务的分组，这些属性都可以存储在数据库中，在多任务的时候使用
//
//        /*
//         * 为需要执行的实体类对应的对象
//         */
//        jobDetail.setTargetObject(new TaskDemo() {
...
//        //tigger.setCronExpression("0 19 22 * * ?");// 初始时的cron表达式
//        tigger.setCronExpression("0/6 * * * * ?");// 初始时的cron表达式
//        tigger.setName("produce-task");// trigger的name
//        return tigger;
//
//    }
//
